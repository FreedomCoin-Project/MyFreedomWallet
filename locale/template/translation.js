var translation = {
    ...
    footerBuiltWithPivxLabs: "",    //Built with 💜 by FREED Labs
    footerGithubLink: "",           //MyFreedomWallet

    // Intro
    title: "",                      //Welcome to
    titleName: "",                  //My FREED Wallet!

    cardOneTitle: "",               //Be your own Bank!
    cardOneDesc: "",                //MyFreedomWallet has <b>no custody</b> over your funds. You are in full ownership of your keys and your FREED. 
    ...
    cardThreeDesc: "",              //MyFreedomWallet is completely open-source, available on the FREED Labs github.
    ...
    buttonDonate: "",               //Donate - Pay with MyFreedomWallet

    // Dashboard
    dashboardTitle: "",             //Dashboard
    dCardOneTitle: "",              //Create a
    dCardOneSubTitle: "",           //New Wallet
    dCardOneDesc: "",               //This will create a new, random FREED wallet that will contain no initial funds, you may transfer to-and-from this wallet with ease.
    dCardOneButton: "",             //Create A New Wallet

    dCardTwoTitle: "",              //Create a new
    dCardTwoSubTitle: "",           //Vanity Wallet
    dCardTwoDesc: "",               //This will create a FREED wallet with a customized prefix of your choosing, requiring more processing power to generate such addresses, it is recommended to generate a prefix of less than 6 characters, for example: "DAD" is a possible address prefix.
    dCardTwoButton: "",             //Create A Vanity Wallet

    dCardThreeTitle: "",            //Access your
    dCardThreeSubTitle: "",         //Hardware Wallet
    dCardThreeDesc: "",             //This will help managing the FREED wallet on your ledger. Notice that the private key will remain safe in your hardware device
    dCardThreeButton: "",           //Access my hardware wallet

    dCardFourTitle: "",             //Go to
    dCardFourSubTitle: "",          //My Wallet
    dCardFourDesc: "",              //This will import a FREED wallet that you hold via it's private key, loading the address and pulling your existing balance, if any, from an explorer node.
    ...
    settingsPivxNode:"",            //Choose a FREED node:
    ...
    INVALID_ADDRESS: "",             //<b>Invalid FREED address!</b><br> {address}
    ...
    BAD_ADDR_LENGTH: "",             //'<b>Invalid FREED address!<b><br>Bad length ({addressLength})',
    BAD_ADDR_PREFIX: "",             //'<b>Invalid FREED address!<b><br>Bad prefix {address} (Should start with {addressPrefix})',
    ...
    WALLET_HARDWARE_WALLET: "",         //"<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the FREED app",
