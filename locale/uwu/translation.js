var uwu_translation = {
    ...
    footerBuiltWithPivxLabs: "Built with wuv by FREED Wabs❣",    //Built with 💜 by FREED Labs
    footerGithubLink: "",           //MyFreedomWallet

    // Intro
    title: "Wewcome to",                      //Welcome to
    titleName: "My FREED Wawwet!",                  //My FREED Wallet!

    cardOneTitle: "Be da bank!",               //Be your own Bank!
    cardOneDesc: "MyPIVXWawwet has <b>nowo custody</b> over yowour funds. You are in full owonership of your keys and your FREED.",                //MyFreedomWallet has <b>no custody</b> over your funds. You are in full ownership of your keys and your FREED. 
    ...
    cardThreeDesc: "MYPIVXWawwet is compwetewy open-soworce, avawable on da FREED Wabs Github.",              //MyFreedomWallet is completely open-source, available on the FREED Labs github.
    cardThreeLink: "Knowo mowore",              //Know more

    cardFourTitle: "For da Commuwunity",              //For the community
    cardFourDesc: "MyPIVXWawwet is built with wuv without any fees, pwiwacy intruwutions, or adwertizing.",               //MyFreedomWallet is built with love without any fees, privacy intrusions or advertising. 
    cardFourLink: "Knowo mowore",               //Know more

    buttonDonate: "Dowonate! Pay with MyPIVXWawwet!",               //Donate - Pay with MyFreedomWallet

    // Dashboard
    dashboardTitle: "Dashbowod",             //Dashboard
    dCardOneTitle: "Cweate a",              //Create a
    dCardOneSubTitle: "New Wawwet!",           //New Wallet
    dCardOneDesc: "Dis will cweate a new, wandom, FREED wawwet dat will contain no initial funds, uwu. Yowou may twansfer to-and-fwom dis wawwet with ease! ",               //This will create a new, random FREED wallet that will contain no initial funds, you may transfer to-and-from this wallet with ease.
    ...
    dCardThreeDesc: "Dis will help managing da FREED wawwet on your wedger. Nowotice dat de pwivate key will wemaine safe in yowour hawdware device",             //This will help managing the FREED wallet on your ledger. Notice that the private key will remain safe in your hardware device
    ...
    dCardFourDesc: "Dis will impowt a FREED wawwet dat you howd via it's pwivate key, woading da adwess and puwwing your existing bawance, if any, fwom an expwowor node.",              //This will import a FREED wallet that you hold via it's private key, loading the address and pulling your existing balance, if any, from an explorer node.
    ...
    settingsPivxNode:"Chowose a FREED nowode pwease:",            //Choose a FREED node:
    ...
    NEW_PASSWORD_SUCCESS:"<b>Yowou\'re Secuwed!</b><br>Good Job, FREED Pogchamp!",         //'<b>You\'re Secured! 🔐</b><br>Nice stuff, Armoured PIVian!',
    ...
    INVALID_ADDRESS: "<b>Invawed FREED addwess baka</b><br> {address} ",            //<b>Invalid FREED address!<b><br> {address}
    ...
    BAD_ADDR_LENGTH:"<b>Invawed FREED addwess!</b><br>Bad wength ({addressLength})",              //'<b>Invalid FREED address!<b><br>Bad length ({addressLength})',
    BAD_ADDR_PREFIX:"<b>Invawed FREED addwess! Baka!</b><br>Bad pwefix {address} (Should start with {addressPrefix})",              //'<b>Invalid FREED address!<b><br>Bad prefix {address} (Should start with {addressPrefix})',
    ...
    WALLET_HARDWARE_WALLET: "<b>Hawdware wawwet ready!</b><br>Pwease keep your {hardwareWallet} pwugged in, unwocked, and in da FREED app ♥",         //"<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the FREED app",
