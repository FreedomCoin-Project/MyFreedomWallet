  ...
  try {
    ...
    if (data.result && data.result.length === 64) {
      ...
      if (domAddress1s.value !== donationAddress)
          ...
          domTxOutput.innerHTML = ('<h4 style="color:green">Thank you for supporting MyFreedomWallet! 💜💜💜<br><span style="font-family:mono !important">' + data.result + '</span></h4>');
...
// FREED Labs Analytics: if you are a user, you can disable this FULLY via the Settings.
